...
#include "CIS_PenetrationAvoidanceFeeler.h"
#include "Camera/CIS_CameraMode.h"
#include "Curves/CurveVector.h"
#include "CIS_CameraMode_ThirdPerson.generated.h"

/**
 * UCIS_CameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class CHARACTERINITIALIZATIONSYSTEM_API UCIS_CameraMode_ThirdPerson : public UCIS_CameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FCIS_PenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
