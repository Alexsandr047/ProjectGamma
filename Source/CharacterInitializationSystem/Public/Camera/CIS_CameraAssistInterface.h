...
#include "CIS_CameraAssistInterface.generated.h"

// This class does not need to be modified.
UINTERFACE(BlueprintType)
class UCIS_CameraAssistInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class CHARACTERINITIALIZATIONSYSTEM_API ICIS_CameraAssistInterface
{
	GENERATED_BODY()
