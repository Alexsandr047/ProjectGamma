...
#include "CIS_AbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FCIS_AbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class CHARACTERINITIALIZATIONSYSTEM_API UCIS_AbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FCIS_AbilityTagRelationship> AbilityTagRelationships;
