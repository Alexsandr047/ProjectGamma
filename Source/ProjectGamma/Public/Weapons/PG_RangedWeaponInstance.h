...
#include "PG_RangedWeaponInstance.generated.h"

/**
 * UPG_RangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class PROJECTGAMMA_API UPG_RangedWeaponInstance : public UPG_WeaponInstance , public ICIS_AbilitySourceInterface
{
	GENERATED_BODY()
	
public:
	UPG_RangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
